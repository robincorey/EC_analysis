...
def plot_function(res,pdb,component):
		...
		for num in ['1','2','3','4','5']:
			file = open('Predicting_site_CARD/raw/%s_%s_%s.csv' % (pdb,num,component), "r")	
			for line in file:
...
for component in components:
	...
	plt.savefig('Figs/Predicted_site_%s_allres_CDL.error.highres.pdf' % component, bbox_inches='tight', dpi=1800,format='pdf')
	plt.cla()
